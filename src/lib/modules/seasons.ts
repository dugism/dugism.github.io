// From http://jgiesen.de/astro/astroJS/seasons/seasons.js
/*
...
let springArray = new Array();
let summerArray = new Array();
let autumnArray = new Array();
let winterArray = new Array();
//let nSpring, n19, n20, n21, n2;
//let dataOK;
...
function computeSeasons(year) {
    ...
    let hourStr, dayStr, monthStr, dayNameStr;
    let marchT, juneT, septemberT, decemberT;
    let dateString;
...
function march() {
    let W, dL;
    //let JDE0 = 2451623.80984 + (365242.37404 + (0.05169  - (0.00411 - 0.00057*y)*y)*y)*y;
...
function june() {
    let W, dL;
    //let JDE0 = 2451716.56767 + (365241.62603 + (0.00325  - (0.00888 - 0.00030*y)*y)*y)*y;
    let JDE0 = 2451716.56767 + 365241.62603 * y + 0.00325 * y * y + 0.00888 * y * y * y - 0.00030 * y * y * y * y;
...
function september() {
    let W, dL;
    //let JDE0 = 2451810.21715 + (365242.01767 + (0.11575  - (0.00337 - 0.00078*y)*y)*y)*y;
    let JDE0 = 2451810.21715 + 365242.01767 * y - 0.11575 * y * y + 0.00337 * y * y * y + 0.00078 * y * y * y * y;
...
function december() {
    let W, dL;
    //let JDE0 = 2451900.05952 + (365242.74049 + (0.06223  - (0.00823 - 0.00032*y)*y)*y)*y;
    let JDE0 = 2451900.05952 + 365242.74049 * y - 0.06223 * y * y - 0.00823 * y * y * y + 0.00032 * y * y * y * y;
