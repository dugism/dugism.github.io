...
exports.getMoonTimes = exports.getMoonIllumination = exports.getMoonPosition = exports.getTimes = exports.addTime = exports.times = exports.getPosition = void 0;
var exports = {};
...
function addTime(angle, riseName, setName) {
    exports.times.push([angle, riseName, setName]);
}
...
function getTimes(date, lat, lng, height) {
    ...
    for (i = 0, len = exports.times.length; i < len; i += 1) {
        time = exports.times[i];
        h0 = (time[0] + dh) * rad;
